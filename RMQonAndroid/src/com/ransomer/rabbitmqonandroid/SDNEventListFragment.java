...
/**
 * A list fragment representing a list of SDNEvents. This fragment also supports
...
public class SDNEventListFragment extends ListFragment {
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(SDNEventStreams.ITEMS.get(position).id);
	}
